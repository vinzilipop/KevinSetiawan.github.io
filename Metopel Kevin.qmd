...
format:
  html: default
---
![logo APP muncul secara random lalalala](app)
## Pendahuluan
...
1.	Apa pengaruh produksi kelapa sawit terhadap volume ekspor CPO Indonesia?
2   Apakah terdapat hubungan signifikan antara peningkatan produksi kelapa        sawit dan perubahan volume ekspor CPO?
3.  Apakah ada faktor lain yang mempengaruhi volume ekspor CPO Indoensia?
...
data <- read_excel('C:/Users/vinz/Desktop/Kevin Latihan/Produksi Kelapa Sawit dan Volume Ekspor CPO (2019-2023).xlsx', col_names = TRUE)
...
Metode yang dipilih adalah regresi univariat  dengan 1 variabel independen dan 1 variable dependent. Penelitian ini bermaksud mencari hubungan antara Produksi kelapa Sawit dan Volume Ekspor CPO Spesifikasi yang dilakukan adalah:
